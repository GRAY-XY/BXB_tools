...
contextBridge.exposeInMainWorld("bxb", {
  ...
  getAutoModes: () => ipcRenderer.invoke("auto:modes:get"),
  setAutoMode: (courseId, mode) => ipcRenderer.invoke("auto:modes:set", { courseId, mode }),
  runAutoComplete: () => ipcRenderer.invoke("auto:run"),
